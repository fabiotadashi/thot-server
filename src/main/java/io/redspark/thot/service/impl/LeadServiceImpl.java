...
public class LeadServiceImpl implements LeadService {
    ...
    public LeadDTO create(CreateLeadDTO createLeadDTO) {
        ...
        User vendor = userRepository.findByName(AuthenticationUtils.getAuthenticatedUserName());
        if(vendor == null){
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, VENDOR_NOT_FOUND);
        }
